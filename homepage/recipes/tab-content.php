...
<div class="tabs-content">
  <div class="tabs-data">
    <?php 
      $select = "SELECT * FROM recipes JOIN users ON recipes.id=users.id JOIN categories ON recipes.cate_id=categories.id  WHERE cate_id = 1 ORDER BY recipes.rid";
    ...
    <div class="cards">
      ...
      ?>
        <div class="card-container">
          <a href="recipe.php?recipe=<?php echo $row['rid'];?>">
          ...
          <div class="card-footer">
            ...
            <?php if(!empty($_SESSION['Username'])){ ?>
              <div class="card-save">
                ...
                ?>
                <a href="../../crud(php)/favourites/remove-save-recipePg.php?rid=<?php echo $rid;?>&uname=<?php echo $_SESSION['Username'];?>" title="Remove from favourites" class="fav-btn">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                ...
                <?php }else{ ?>
                <a href="../../crud(php)/favourites/save-recipePg.php?rid=<?php echo $rid;?>&uname=<?php echo $_SESSION['Username'];?>" title="Add to favourites" class="fav-btn remove">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
  ...
  <div class="tabs-data">
    <?php 
      $select = "SELECT * FROM recipes JOIN users ON recipes.id=users.id JOIN categories ON recipes.cate_id=categories.id  WHERE cate_id = 2 ORDER BY recipes.rid";
      $exe = mysqli_query($conn,$select);
      if(mysqli_num_rows($exe)>0){
    ?>
    <div class="cards">
